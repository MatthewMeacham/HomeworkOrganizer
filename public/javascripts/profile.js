...
function changeDaysLeapYear() {
	if(document.getElementById('monthassignment').options[document.getElementById('monthassignment').selectedIndex].value == '02') {
		removeOptions(document.getElementById('daysassignment'));
		if(Number(document.getElementById('yearassignment').options[document.getElementById('yearassignment').selectedIndex].value) % 4 == 0) {
			for(i = 1; i < 30; i++) {
...
function toggle_visibility(id) {
	...
	var css = 'nav li a:hover {color: #56ced6}';
	hover = document.createElement('hover');
